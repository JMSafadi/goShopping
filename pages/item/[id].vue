        ...
        <div class="md:w-[60%] bg-white p-3 rounded-lg">
          ...
          <div class="border-b">
            <div class="flex items-center justify-start gap-2 my-2">
              ...
              <span class="bg-[#F5F5F5] border text-[#C08562] text-[9px] font-semibold px-1.5 rounded-sm"></span>
            </div>
            <p class="text-[#009A66] text-xs font-semibold p-1">Free 11-day delivery over $ 8.28</p>
            <p class="text-[#009A66] text-xs font-semibold p-1">Free Shipping</p>
            <div class="py-2">
